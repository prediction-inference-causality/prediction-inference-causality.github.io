...
(e) Write the equations for each or your models using $\beta_i$ as your parameters. Fill in the following table using with the $\beta$s from your models (not numbers, for example $\beta_0 + \beta_1$. 
