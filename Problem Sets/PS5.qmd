...
(h) Write the equations for each or your models using $\beta_i$s as your parameters. Fill in the following table using with the $\beta$s from your models (not numbers, for example $\beta_0 + \beta_1$.) Then fill in the table using the estimates from your models. 

\begin{tabular}{|c|c|c|c|c| }
\hline
 & Age Group & Proportion Breast Cancer T=1 & Proportion Breast Cancer T=0 & $\hat{ATE}|Age$ \\
\hline
$\beta$s & 50-59 & & & \\ 
 \hline
$\beta$s & 60-69 & & & \\
