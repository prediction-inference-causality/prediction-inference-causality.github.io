...
\begin{itemize}
\item Today we consider the context where we have a random sample from a large population. 
...
\section{Population Inference for Proportions}
...
\begin{figure}[ht] \centering
        \scalebox{.5}{\includegraphics{figs/samdist.pdf}}
\end{figure}
...
\frame{
\begin{figure}[ht] \centering
        \scalebox{.5}{\includegraphics{figs/estsamdist.pdf}}
\end{figure}
...
\frame{
\begin{figure}[ht] \centering
        \scalebox{.5}{\includegraphics{figs/samdistCI.pdf}}
\end{figure}
...
\section{Population Inference for Means}
...
Unlike the turnout example, we will never know the true population income mean, which we will denote with $\mu$. \pause We will also never know the population income standard deviation, which we will denote $\sigma$ and the population variance with $\sigma^2$.  \pause


\bigskip

\begin{enumerate}
\item Is \$135,406 close to the population mean $\mu$?  
\item Can say something about how close? 
\end{enumerate} 
...
\visible<1->{$E_{\cdot}(\cdot)$} & \multicolumn{1}{r|}{\visible<1->{$\mu$}} & \multicolumn{1}{r|}{\visible<1->{$\mu$}}  &$\dots$ & \multicolumn{1}{r|}{\visible<1->{$\mu$}} & \visible<1-2>{?}\hspace{-.17cm}\visible<3->{\textcolor{red}{?}} \\
...
\hline
1 & 37,006 & 108,811   & $\dots$  &  49,001  & 135,406   \\ %& \visible<2->{.037} & \visible<3->{[.643,.717]}\\
\visible<1->{2} & \visible<1->{152,001} & \visible<1->{174,261}   & \visible<1->{$\dots$}  & \visible<1->{75,105} & \visible<1->{135,956} \\ %& \visible<2->{.037}  & \visible<3->{[.663,.737]}\\
\visible<1->{3} & \visible<1->{4,800} & \visible<1->{52,000}  & \visible<1->{$\dots$}  & \visible<1->{169,900} & \visible<1->{133,790} \\ %& \visible<2->{.035} & \visible<3->{[.715,.785]}\\
...
\visible<1->{1 mil}  & \visible<1->{80,149} & \visible<1->{36,001} & \visible<1->{$\dots$}  & \visible<1->{187,078} & \visible<1->{134,127} \\ %& \visible<2->{.035}& \visible<3->{[.705,.775]}\\
 \visible<1->{$\vdots$}  & \visible<1->{$\vdots$}  & \visible<1->{$\vdots$} & \visible<1->{$\vdots$} & \visible<1->{$\vdots$}  & \visible<1->{$\vdots$} \\ % & \visible<2->{$\vdots$} & \visible<3->{$\vdots$}\\
\hline
\visible<1->{$f_{\cdot}(\cdot)$} & \multicolumn{1}{r|}{\visible<1->{?}} & \multicolumn{1}{r|}{\visible<1->{?}}  &$\dots$ & \multicolumn{1}{r|}{\visible<1->{?}} & \visible<1->{?} \\
...
Unlike the turnout example, we will never know the true population mean, which we will denote with $\mu$.  We will also never know the population standard deviation, which we will denote $\sigma$ and the population variance with $\sigma^2$.

\bigskip

\begin{enumerate}
\item Is \$135,406 close to the population mean $\mu$? \pause Across possible random samples, we will get the right answer on average, but how close on average. \pause
\item Can say something about how close? 
\end{enumerate} 
...
\visible<1->{$V_{\cdot}(\cdot)$} & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}} & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}}  &$\dots$ & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}} & \visible<1-2>{?}\hspace{-.17cm}\visible<3->{\textcolor{red}{?}} \\
\end{tabular}}
\end{center}
\end{table}
