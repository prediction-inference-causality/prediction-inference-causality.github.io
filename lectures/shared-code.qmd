...
with_annotations = function(samples,
    ...
    dot.geom = if(dots == 0) geom_blank() else {
        ...
        heights = (\(){ 
              highlight.dot.heights = sample(1:highlight.dots)/highlight.dots
              unhighlighted.dot.heights = setdiff(sample(1:dots), 1:highlight.dots)/dots
