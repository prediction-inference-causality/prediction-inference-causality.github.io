...
$y_i$ & 1 & 1 & 0 & 1 & $\dots$ & 0 & .68 & .69 \\
\end{tabular}
\end{center}
\end{table} 

Starting with the sample (first row of sampling distribtuion), each row of the bootstrapped sampling distribution is generated as the following:
\begin{verbatim}
