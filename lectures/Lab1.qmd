...
```{webr-r}
with.replacement = function(pop, sampling.rate=sampling.rate) {
  N = round(m * sampling.rate) 
...
without.replacement = function(pop, sampling.rate=sampling.rate) {
  N = round(m * sampling.rate) 
...
by.randomization = function(pop, sampling.rate=sampling.rate) {
...
```{webr-r}
# editor-code-line-numbers: 2
by.shuffling = function(pop, sampling.rate=sampling.rate) {
  N = round(m * sampling.rate) 
...
```{webr-r}
# editor-code-line-numbers: 2
randomization.then.sampling = function(pop, sampling.rate=sampling.rate) {
  flips = rbinom(m, 1, sampling.rate)
