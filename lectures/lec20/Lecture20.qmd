...
- We'll take them at random times, too---there are many observations $(z_j,x_j,y_j)$ at the same location $(x_j,y_j)$ in the population we're sampling from. We'll sample with replacement. The probability a sample is at a given location is shown on the right.
...
![](isl-fig8-3.png){width=500px,height=500px}
