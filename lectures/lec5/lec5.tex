...
\frame{
\frametitle{Properties of Population Variances: Conditioning}

The law of total variance
$$
V[Y] = \E\qty{V\qty( Y \mid X ) } + V\qty{\E\qty( Y \mid X ) }  \text{ for RVs $X, Y$} 
$$

Proof:
\begin{align*}
V[Y] &= \E\qty{ Y^2 } -  \E\qty{ Y }^2\\
&= \E\qty{\E\qty( Y^2 \mid X) } -  \E\qty{\E\qty( Y \mid X)}^2\\
&= \E\qty{V\qty( Y \mid X) + \E\qty( Y \mid X)^2 } -  \E\qty{\E\qty( Y \mid X)}^2\\
&= \E\qty{V\qty( Y \mid X)} + \qty[ \E\qty{\E\qty( Y \mid X)^2 } -  \E\qty{\E\qty( Y \mid X)}^2]\\
&= \E\qty{V\qty( Y \mid X)} + V\qty{\E\qty( Y \mid X)}
\end{align*}
}
