...
display.population = sample_n(finite.population, 250000) 
...
% so do the same thing with commands
\newcommand{\inred}[1]{\textcolor[RGB]{248,118,109}{#1}}
\newcommand{\ingreen}[1]{\textcolor[RGB]{0,191,196}{#1}}

\newcommand{\with}{\ingreen{\text{with}}}
\newcommand{\without}{\inred{\text{without}}}
