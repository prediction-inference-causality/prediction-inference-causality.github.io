...
\begin{align*}
\frac{\partial SSR}{\partial \tilde{B}_0} &=  - \sum_{i=1}^N 2e_i \\
...
We set equal to zero when solving. 
...
Suppose we want $B_1$ from $y_i=B_{0}+B_{1}x_{i}+B_{2}z_{i}+B_{3}w_{i}+e_i$, but we run the regression of $y$ on $x$ alone. Suppose also that we have de-meaned $x_i$, $z_i$, and $w_i$such that $\bar x = 0$, $\bar z =0$, and $\bar w = 0$. Then,
{\small
\begin{align*}
&\frac{\sum\limits_{i=1}^{n} x_i y_{i}}{\sum\limits_{i=1}^{n}x_i^2} = \visible<2->{\frac{\sum\limits_{i=1}^{n} x_i (B_{0}+B_{1}x_i+B_{2}z_i+B_{3}w_{i}+e_i)}{\sum\limits_{i=1}^{n}x_i^2}}\\
&=\visible<3->{\frac{\sum\limits_{i=1}^{n}x_iB_{0}}{\sum\limits_{i=1}^{n}x_i^2}+\frac{\sum\limits_{i=1}^{n}x_iB_{1}x_i}{\sum\limits_{i=1}^{n}x_i^2}+\frac{\sum\limits_{i=1}^{n} x_i B_{2}z_i}{\sum\limits_{i=1}^{n}x_i^2} +\frac{\sum\limits_{i=1}^{n} x_i B_{2}w_i}{\sum\limits_{i=1}^{n}x_i^2} +\frac{\sum\limits_{i=1}^{n} x_i e_i}{\sum\limits_{i=1}^{n}x_i^2}  }\\
&= \visible<4->{ B_1+ B_2 \cdot  \frac{\sum\limits_{i=1}^{n}x_i z_i}{\sum\limits_{i=1}^{n}x_i^{2}}+ B_3 \cdot  \frac{\sum\limits_{i=1}^{n}x_i w_i}{\sum\limits_{i=1}^{n}x_i^{2}} }
\end{align*}}
...
{\footnotesize
\begin{align*}
&\frac{\sum\limits_{i=1}^{n} \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right] y_{i}}{\sum\limits_{i=1}^{n} \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2} = \visible<2->{\frac{\sum\limits_{i=1}^{n}  \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right] (B_{0}+B_{1}x_i+B_{2}z_i+e_i)}{\sum\limits_{i=1}^{n} \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2}}\\
&=\visible<3->{\frac{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]B_{0}}{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2}+\frac{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]B_{1}x_i}{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2}}\\
&+\visible<4->{\frac{\sum\limits_{i=1}^{n} \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right] B_{2}z_i}{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2} + \frac{\sum\limits_{i=1}^{n} \left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right] e_i}{\sum\limits_{i=1}^{n}\left[x_i - \left(\frac{\sum\limits_{i=1}^{n} z_i x_i}{\sum\limits_{i=1}^{n} z_i^2}\right)z_i\right]^2}  }\\
&= \visible<5->{ B_1}
\end{align*}}
