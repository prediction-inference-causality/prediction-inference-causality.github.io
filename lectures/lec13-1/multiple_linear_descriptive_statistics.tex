...
\frame{
\frametitle{Simple proof continued (part 1)}
\begin{align*}
y &= \beta_0 + \beta_1 x + \beta_2 z + \epsilon \\
x &= \alpha_0 + \alpha_1 z + v
\end{align*}
...
\begin{align*}
Cov(\epsilon,v) &= Cov(\epsilon,x - \alpha_0 - \alpha_1 z) \\
&= Cov(\epsilon,x) - Cov(\epsilon,\alpha_0) - Cov(\epsilon, \alpha_1 z) \\
&= 0 - 0 - \alpha_1Cov(\epsilon, z) \\
&= 0 - 0 - 0
\end{align*}
...
\frame{
\frametitle{Simple proof continued (part 2)}
