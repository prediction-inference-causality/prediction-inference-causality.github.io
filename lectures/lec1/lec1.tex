...
\begin{figure}[ht] \centering
        \scalebox{.4}{\includegraphics[angle=90,origin=c]{figs/CLhistActSol.pdf}}
\end{figure}
...
\begin{figure}[ht] \centering
        \scalebox{.35}{\includegraphics{figs/partyMean.pdf}}
\end{figure}
...
\begin{figure}[ht] \centering
        \scalebox{.35}{\includegraphics{figs/lmBin.pdf}}
\end{figure}
