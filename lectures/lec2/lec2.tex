...
\item If $n$ is big enough, the bootstrapped sampling distribution of the proportion is approximately normally distributed due to the De Moivre - Laplace Theorem.\pause
...
\frame{
\frame{The Current Population Survey}
