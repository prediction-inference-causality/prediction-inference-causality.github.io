...
\begin{enumerate}
\item Is \$135,406 close to the population mean?  
\item Can say something about how close? 
\end{enumerate} \pause
\bigskip

Unlike the turnout example, we will never know the true population mean.
...
\visible<1->{$E_{\cdot}(\cdot)$} & \multicolumn{1}{r|}{\visible<1->{$\mu$}} & \multicolumn{1}{r|}{\visible<1->{$\mu$}}  & & \multicolumn{1}{r|}{\visible<1->{$\mu$}} & \visible<1->{?} \\
\visible<1->{$V_{\cdot}(\cdot)$} & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}} & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}}  & & \multicolumn{1}{r|}{\visible<1->{$\sigma^2$}} & \visible<1->{?} \\
\end{tabular}}
