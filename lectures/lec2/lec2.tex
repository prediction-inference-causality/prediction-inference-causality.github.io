...
\item Our goal is to summarize the population with population means, conditional population means, and differences in conditional population means.
...
\begin{enumerate}
\item .68 is close to .70, did we get lucky? \pause No! \pause
...
\frame{
\frametitle{Informal Conditions for Confidence Intervals}
 If the following are true,\\ \pause
...
\begin{itemize}
\item the sampling distribution is symmetric about the population proportion,\pause

\item the estimated sampling distribution is symmetric about the sample proportion,\pause

\item the width of the middle 95\% of the sampling distribution is equal to the width of the middle 95\% of the estimated sampling distribution, 
\end{itemize}\pause


\vspace{.3cm}

then the following logic for the 95\% confidence interval will hold.
...
%\frame{
%\begin{figure}[ht] \centering
%        \scalebox{.5}{\includegraphics{samdistCI.pdf}}
%\end{figure}
%
%}
