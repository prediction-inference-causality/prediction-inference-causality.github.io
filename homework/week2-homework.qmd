...
mapping between the point estimate and the sampling distribution, so the way estimating this sampling 
distribution affects calibration is a bit more complex than it is here. My hope is that, having a shared
visual language for how calibration works in this simple case, we'll have an easier time talking about 
how it works when it's a bit more complicated.
