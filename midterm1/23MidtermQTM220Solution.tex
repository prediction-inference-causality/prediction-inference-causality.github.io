...
Suppose we store univariate sample data in a vector $y$ of length $n$ and we want to learn about population mean using the following code:
...
\item[f)] How could you re-write the code in part d) using sd(y.bar)?
